...
/*
    ...
    PureComponent不适用的场景注意：如果你的 state 或者props 永远都会变 ，
    那PureComponent并不会比较快，因为 shallowEqual（对比新老状态state或属性prop） 也需要花时间 ，如在倒计时组件这种状态或者属性一直在变化的组件中 PureComponent并不适用优化
